...
<section class="content-header head">
    ...
    <form name="form" method="post" action="<?php base_url()?>broker_report_purchase">
                  		...
                  		<div class="box">
                   	 		<div class="box-body" id="colvis">                                                 
	                             <table id="example1" class="table table-bordered table-striped">
                             		<thead>  
                                		<tr>
                                        	<th>Sr</th><th>Date</th><th>Broker Name</th><th>Supplier Name</th><th>Bages</th><th>Weight</th><th>Rate</th><th>Amount</th><th>Brokri</th><th>Net Brokri</th>
                                        </tr>
                                    </thead>
                                    <tbody>                               
											 <?php
                                            $counter = 1; 
                                            foreach($broker_bill_report as $row){ 
                                            $bales1 = $row->bales;
                                            $weight1 = $row->weight;
                                            $amount1 = $row->supplier_total;
                                            $total_amount1  += $amount1;
                                            $total_weight1 += $weight1;
                                            $total_bales1 += $bales1;
											$broker_ratio = $config->broker_ratio;
											$broker_tax = $config->broker_tax_ratio;
                                            $brokri = ($amount1*$broker_ratio)/100;
                                            $total_brokri += $brokri;
                                            $tax = ($brokri*$broker_tax)/100;
                                            $net_brokri = $brokri-$tax;
                                            $total_net += $net_brokri;
                                            ?>
                                   		<tr>  
                                            ...
                                            <td><?php echo round($row->rate,2);?></td>   
                                    ...
                                    <tfoot>
                                		<tr>
                                            ...
                                            <td><h3>Total </h3></td>
                                            <td>&nbsp;</td>
                                            <td><h3><?php echo $total_bales1;?></h3></td>
                                            <td>&nbsp;</td>
                                            <td>&nbsp;</td>
                                            <td><h3><?php echo round($total_amount1,2);?></h3></td>
