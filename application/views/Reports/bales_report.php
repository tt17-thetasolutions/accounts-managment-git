...
<section class="content-header head">
    ...
    <form name="form" method="post" action="<?php base_url()?>bale_report">
                  		...
                  		<div class="box">
                   	 		<div class="box-body" id="colvis">                                                 
	                             <table id="example1" class="table table-bordered table-striped">
                             		<thead>                            
                                		<tr>
                                        	<th>Sr#</th><th>Date</th><th>Name</th><th>Item Name</th><th>Invoice No</th><th>Lot No</th><th>Bales</th><th>Weight</th><th>Rate</th><th>Gross Amount</th><th>Tax Amount</th><th>Net Amount</th>
                                         </tr>
                                     </thead>
                                     <tbody>                                                                     
										<?php
                                        ...
                                        ?>
                                            ...
                                            <td><?php echo $bales;?></td>
                                            <td><?php echo $row->weight;?></td>
                                            <td><?php echo $row->inv_price;?></td>
                                            <td><?php echo round($gross_amount,3);?></td>
                                            <td><?php echo $row->tax_amount;?></td>
                                            <td><?php echo round($net_amount,3);?></td>                   
                                  		  </tr>
                               			 <?php $counter++ ; }?>
                                         </tbody>
                                         <tfoot>
